...
export async function fetchProjects() {
  // No mock data -- only real dispatched jobs (insertedProjects) appear in My Projects
  return [] as {
    id: string
    title: string
...
// Legacy review functions kept as stubs for type compatibility
export async function fetchProjectDetail(_projectId: string) { return null }
export async function reviewSynopsis(_projectId: string, _action: string, _feedback?: string) { return { success: true, message: "" } }
export async function reviewScript(_projectId: string, _action: string, _edits?: string) { return { success: true, message: "" } }
export async function reviewEpisode(_projectId: string, _episodeId: string, _action: string) { return { success: true, message: "" } }
export async function downloadEpisode(_episodeId: string) { return { success: true, message: "" } }
